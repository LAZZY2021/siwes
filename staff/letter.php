...
font-size: 16px;">
                <font style="font-size:23px; font-family:Bauhaus 93;">Siwes Management System</font><a href="logout.php"
                    class="btn btn-danger square-btn-adjust" style="float: right;">Logout</a>
            </div>
        </nav>
        <!-- /. NAV TOP  -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="col-md-3">
                                    <h6 class="mb-10 pl-15" style="font-weight:bold; font-size:20px; color:;">Students
                                    </h6>
                                    <ul class="folder-list mb-30"
                                        style="height:500px; overflow-y:auto; border-right:1px solid lavender;">
                                        <?php
...
if(isset($_GET['sid'])){
	...
	?>
                                    ...
                                    <div class="" style="">
                                        <div style="margin-top:15px; margin-bottom:20px;" class="pull-right"><a
                                                href="?discard=<?php echo $sut['id']; ?>" class="btn btn-danger"><i
                                                    class="fa fa-times-circle"></i> Discard Letter</a></div>
                                        <div class="imgcontainer" style="margin-left:25px;">
                                            <img src="../images/fpb.png">
                                        </div>
...
e-mail: Computer.Science@lasu.edu.ng
                                        ...
                                        <div
                                            style="border:6px double #0059b3; margin-top:5px; padding:0 27px; height:;">

                                            <center>
                                                <div
                                                    style="background-color:#80bfff; width:250px; border:3px solid #efefef; height:; padding:4px;">
                                                    <p
                                                        style="font-family:calibri; font-size:15px; margin-top:-20px; margin-bottom:1px;">
                                                        Office of the Head of Department </p>
                                                </div>
                                            </center>
                                            ...
                                            <div style="text-align:center;"><u
                                                    style="font-family:Times New Roman; text-align:center; font-size:16px; color:black;">LETTER
                                                    OF INTRODUCTION FOR THE PURPOSE OF STUDENT INDUSTRIAL <br>
                                            ...
                                            <p
                                                ...
                                                SIWES in a reputable establishment like yours.
                                                This is expected to give the students the opportunity to acquire
                                                practical skills of IT, identify local IT needs and to help
                                                establishments by providing IT supports.
                                            </p>


                                            <p
                                                style="text-align:justify; font-family:Times New Roman; font-size:16px; color:black;">
                                                The student seeks your permission to undertake his/her SIWES in your
                                                establishment.
                                                I am very happy to support his/her request because I am convinced that
                                                he/she will be useful for your establishment and will also learn new
                                                things from your establishment.
                                                The student is expected to spend 4 weeks with you and will be required
                                                to submit a report to ISCOM University upon the completion of the SIWES.
                                                He will need your help to sign his log book and will also need a letter
                                                of SIWES completion from you upon the completion of the programme.</p>
